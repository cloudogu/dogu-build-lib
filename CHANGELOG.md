...
## [Unreleased]
### Changed
- switched from google-cloud-sdk-gke-gcloud-auth-plugin to google-cloud-cli-gke-gcloud-auth-plugin 
...
### Fixed
- use jenkins-worker for downloading wget, so wget is not mandatory within dogu-images

## [v3.4.2] - 2025-08-27
### Fixed
- use preset 'none' due to coder version update

## [v3.4.1] - 2025-08-27
### Fixed
- use goss binaries in tmp directory

## [v3.4.0] - 2025-08-22
### Fixed
- Failsafe for first pipeline-build with empty clustername
